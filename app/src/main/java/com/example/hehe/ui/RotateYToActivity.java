...
public class RotateYToActivity extends BaseAminActivity {
    ...
    public void clickActionBtn(@NotNull View runView) {
        RunAction.INSTANCE.runAction(runView, Action.INSTANCE.rotateYTo(time, rotationY));
    }
